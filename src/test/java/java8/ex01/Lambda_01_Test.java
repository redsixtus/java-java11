...
public class Lambda_01_Test {
    ...
    public void test_filter_by_age() throws Exception {
        ...
        PersonPredicate test= (Person p)-> p.getAge() >=18 ;
    ...
    public void test_filter_by_firstname() throws Exception {
        ...
        PersonPredicate test= (Person p)-> p.getFirstname().equals("first_10");
    ...
    public void test_filter_by_password() throws Exception {
        ...
        PersonPredicate test = (Person p)-> {
               String mot = DigestUtils.sha512Hex(p.getPassword());
               if (mot.equals(passwordSha512Hex) ){

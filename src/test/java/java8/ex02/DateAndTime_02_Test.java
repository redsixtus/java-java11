...
public class DateAndTime_02_Test {
    ...
    public void test_localDate_format_with_hour() {
        ...
        localDate.format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss.SSS"));
    }
    ...
    public void test_with() {
        ...
        LocalDate result = localDate.withYear(2015).with(ChronoField.DAY_OF_MONTH,05).with(ChronoField.MONTH_OF_YEAR,2);
